...
const p: ProductoCompleto = {
  ...
  specs: [{
    id: 's1', producto_id: 'p1', config_id: cfg, opcion_id: 'o1', nombre: 'Packaging',
    valor: 'Bolsa PVC con cierre', foto: B + 'pack.jpg', definido: true, orden: 0,
  }],
  fotos: [{ id: 'f1', producto_id: 'p1', config_id: cfg, url: B + 'rojo.jpg', titulo: 'Referencia', orden: 0 }],
...
console.log('esperadas: 5 (producto, estilo, packaging, 2 colores, galería) -> al menos 5')
console.log(imgs.length >= 5 ? 'OK las fotos entran' : 'FALLA faltan fotos')
